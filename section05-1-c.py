...
<html>
    ...
    <body>
        ...
        <p class="story">Once upon a time there were three little sisters
            ...
            <a data-test="test" data-io="link3" href="http://example.com/tillie" class="sister" id="link3">Tillie</a>
        </p>
...
link2 = soup2.find_all(
    "a", class_="sister"
)  # id="link2" , string="Tillie" , string=["Elsie"] , {} 다중 조건
print(link2)
...
print(link6.string)
# 태그 + 속성 선택자
link7 = soup2.select_one("a[data-test='test']")
# 전체 구조 및 텍스트 출력
print()
print(link7)
print(link7.text)
print(link7.string)  # . : 클래스, # : 아이디
